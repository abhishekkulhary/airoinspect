...
public class DoubleXLabelAxisRenderer extends XAxisRenderer {
    ...
    private ValueFormatter bottomValueFormatter;

    public DoubleXLabelAxisRenderer(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer transformer, ValueFormatter topValueFormatter, ValueFormatter bottomValueFormatter) {
    ...
    public void renderAxisLabels(Canvas c) {
        ...
        if (mXAxis.getPosition() == XAxis.XAxisPosition.TOP) {
            ...
            pointF.x = 0.5f;
            pointF.y = 0.0f;
            drawLabelsBottom(c, mViewPortHandler.contentBottom() + yoffset, pointF);
        }
    ...
    private void drawLabelsBottom(Canvas c, float pos, MPPointF anchor) {
        ...
        for (int i = 0; i < positions.length; i += 2) {
            ...
            if (mViewPortHandler.isInBoundsX(x)) {
                ...
                String label = bottomValueFormatter.getFormattedValue(mXAxis.mEntries[i / 2]);
